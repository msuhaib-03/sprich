# Third-Party Data & License Notices
...
- Version imported: `1.9-fd1`
- Upstream project: https://freedict.org/ and the Ding dictionary by Frank Richter
- License: **GNU General Public License v3 (GPLv3)** and
  **GNU Affero General Public License v3 (AGPLv3)**.
  See https://www.gnu.org/licenses/gpl-3.0.html and
...
2. Under the **AGPLv3**, if you make this dictionary available to users over a
   ...
   plus the `ding2tei-haskell` conversion program (see the FreeDict release).
3. You may not add further restrictions to the dictionary data beyond those in
   the GPLv3/AGPLv3.

If these obligations are incompatible with your commercial/closed-source goals,
