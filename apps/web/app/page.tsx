...
const PROBLEMS = [
  ...
  },
  {
    app: "Babbel",
    problem:
      "Vocabulary lists with no grammar context. You memorize, not understand.",
  },
  {
...
const COMPARISON = [
  {
    feature: "Grammar with reasoning (WHY)",
    dolang: true,
    duolingo: false,
    babbel: false,
  },
  {
    feature: "Color-coded case breakdowns",
    dolang: true,
    duolingo: false,
    babbel: false,
  },
  ...
  {
    feature: "Public speaking confidence training",
    dolang: true,
    duolingo: false,
    babbel: false,
  },
  {
    feature: "Spaced repetition vocabulary",
    dolang: true,
    duolingo: true,
    babbel: true,
  },
  {
    feature: "Goal-personalized curriculum",
    dolang: true,
    duolingo: false,
    babbel: false,
  },
  {
    feature: "Level certificates",
    dolang: true,
    duolingo: false,
    babbel: true,
  },
  {
    feature: "Smart daily coach (not guilt streaks)",
    dolang: true,
    duolingo: false,
    babbel: false,
  },
        ...
        <div className="max-w-4xl w-full mx-auto">
          ...
          <div className="grid gap-4"> 
            {PROBLEMS.map((p) => (
              <div
                key={p.app}
                className="flex items-start gap-4 p-5 rounded-xl border border-[var(--border)] bg-[var(--bg)]"
              >
        ...
        <div className="max-w-4xl w-full mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--muted)] max-w-xl mx-auto">
              Every sentence broken down. Every case explained. Every rule with
              a reason.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8 mb-6">
            ...
            <div className="grid sm:grid-cols-3 gap-3 mb-8">
              ...
              <div className="rounded-lg border border-orange-500/20 bg-orange-500/5 p-3">
                ...
                <p className="text-[var(--faint)] text-xs">
                  Masculine → ein becomes einen
                </p>
              </div>
              <div className="rounded-lg border border-pink-500/20 bg-pink-500/5 p-3">
                <p className="text-pink-400 text-xs font-semibold uppercase tracking-wide mb-1">
                  Accusative · Direct Object
                </p>
                <p className="text-[var(--text)] font-mono text-sm">
                  eine Schwester
            ...
            <div className="rounded-xl border border-[#d4a843]/20 bg-[#d4a843]/5 p-5">
              ...
              <p className="text-[var(--text-soft)] text-sm leading-relaxed">
                &quot;Bruder&quot; is masculine (
                <span className="text-blue-400 font-mono">der Bruder</span>). In
                Accusative, <strong>only masculine articles change</strong>:{" "}
                <span className="text-[var(--text)] font-mono">
                  ein → einen
                </span>
                . Feminine (<span className="text-pink-400 font-mono">die</span>
                ) and neuter (
                <span className="text-green-400 font-mono">das</span>) stay
                exactly the same. This is the only transformation you need to
                master for Accusative.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-white/5">
                  ...
                  <tr>
                    <td className="py-3 text-pink-400 font-semibold">
                      Feminine
                    </td>
            ...
            <p className="text-[var(--faint)] text-xs mt-4">
              ← Only masculine changes in Accusative. Everything else stays the
              same.
            </p>
          </div>
        </div>
      ...
      <section className="min-h-svh flex flex-col items-center justify-center py-24 px-6">
        <div className="max-w-3xl w-full mx-auto">
          ...
          <p className="text-[var(--muted)] text-center mb-12">
            The features that actually matter for real German fluency.
          </p>
          <div className="rounded-2xl border border-[var(--border)] overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="text-left p-4 font-medium text-[var(--faint)]">
                    Feature
                  </th>
                  <th className="p-4 text-center font-bold text-[var(--gold)]">
                    doLang
                  </th>
                  <th className="p-4 text-center font-medium text-[var(--faint)]">
                    Duolingo
                  </th>
                  <th className="p-4 text-center font-medium text-[var(--faint)]">
                    Babbel
      ...
      <section className="min-h-svh flex flex-col items-center justify-center py-24 px-6 text-center">
        <div className="max-w-2xl w-full mx-auto">
          ...
          <p className="text-[var(--muted)] mb-10">
            Free to start. No credit card. No guilt streaks. Just real German
            learning.
          </p>
          <Link
            href="/signup"
