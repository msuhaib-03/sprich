 ...
 * proxy (`<web-origin>/api/v1/*` → this service), so the browser attributes
 * this cookie to the web origin itself. First-party + `SameSite=Lax` is what
 * iOS Safari reliably keeps.
 */
